...
> py -3.9-64 setup.py build_ext --inplace --build-lib .\conduit_raw\workers
...
path = pathlib.Path('conduit_raw/__init__.py')
...
setup(
    ...
    ext_modules=cythonize("conduit_raw/workers/_algorithms.pyx"),
    zip_safe=False,
