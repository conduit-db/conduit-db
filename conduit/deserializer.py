...
from bitcoinx import read_le_int32, read_le_uint64, read_le_int64, read_varbytes, read_le_uint32, \
    read_varint, read_le_uint16, hash_to_hex_str
...
class Deserializer:
    ...
    def protoconf(self, f):
        ...
        return {'number_of_fields': number_of_fields,
    ...
    def headers(self, f):
        ...
        for i in range(count):
            ...
            _hash = utils.get_block_hash(header)  # calculates hash as part of validation
